const apiTranslations = {
    en: {
        ...
        solution: { label: "Auto-Generated", title: "AI reads your routes, schemas,<br>and generates everything.", subtitle: "DocKit Master inspects actual endpoints, middleware, auth layers — and generates multi-language examples.", terminal: { cmd: "bash doc-gen.sh --type api --format astro", output: ["✓ Scanning API routes: 67 endpoints found", "✓ Auth layer: JWT + API Key documented", "✓ Request/Response schemas extracted", "✓ Error codes: 23 unique codes documented", "✓ Examples generated: cURL, JavaScript, Python", "✅ API Reference site ready!"] } },
        benefits: {
        ...
        steps: { label: "How It Works", title: "3 steps. Done.", s1: { title: "Install", desc: "Copy doc-kit to your AI agent.", code: "cp -r doc-kit ~/.gemini/antigravity/skills/" }, s2: { title: "Scan API", desc: "Select 'api' type in the CLI.", code: "bash doc-gen.sh" }, s3: { title: "Deploy", desc: "AI generates complete API reference.", result: "Endpoints, schemas, auth, errors — with cURL/JS/Python examples." } },
    ...
    vi: {
        ...
        solution: { label: "Tự Động Tạo", title: "AI đọc routes, schemas,<br>và tạo mọi thứ.", subtitle: "DocKit Master inspect endpoints, middleware, auth — tạo examples đa ngôn ngữ.", terminal: { cmd: "bash doc-gen.sh --type api --format astro", output: ["✓ Quét API routes: 67 endpoints", "✓ Auth: JWT + API Key", "✓ Request/Response schemas", "✓ Error codes: 23 mã", "✓ Examples: cURL, JS, Python", "✅ API Reference sẵn sàng!"] } },
        benefits: {
        ...
        steps: { label: "Cách Hoạt Động", title: "3 bước. Xong.", s1: { title: "Cài Đặt", desc: "Copy doc-kit.", code: "cp -r doc-kit ~/.gemini/antigravity/skills/" }, s2: { title: "Quét API", desc: "Chọn 'api' trong CLI.", code: "bash doc-gen.sh" }, s3: { title: "Deploy", desc: "AI tạo API reference đầy đủ.", result: "Endpoints, schemas, auth, errors — cURL/JS/Python examples." } },
    ...
    ru: {
        ...
        solution: { label: "Автогенерация", title: "ИИ читает маршруты, схемы<br>и генерирует всё.", subtitle: "DocKit Master проверяет эндпоинты, middleware, аутентификацию.", terminal: { cmd: "bash doc-gen.sh --type api --format astro", output: ["✓ Сканирование: 67 эндпоинтов", "✓ Auth: JWT + API Key", "✓ Схемы запросов/ответов", "✓ Коды ошибок: 23", "✓ Примеры: cURL, JS, Python", "✅ API Reference готов!"] } },
        benefits: {
        ...
        steps: { label: "Как это работает", title: "3 шага. Готово.", s1: { title: "Установка", desc: "Скопируйте doc-kit.", code: "cp -r doc-kit ~/.gemini/antigravity/skills/" }, s2: { title: "Сканирование", desc: "Выберите 'api'.", code: "bash doc-gen.sh" }, s3: { title: "Деплой", desc: "ИИ создаст полный API reference.", result: "Эндпоинты, схемы, auth, ошибки — cURL/JS/Python." } },
    ...
    zh: {
        ...
        solution: { label: "自动生成", title: "AI 读取路由、模式，<br>生成一切。", subtitle: "DocKit Master 检查端点、中间件、认证层 — 生成多语言示例。", terminal: { cmd: "bash doc-gen.sh --type api --format astro", output: ["✓ 扫描 API 路由：67 个端点", "✓ 认证：JWT + API Key", "✓ 请求/响应模式", "✓ 错误码：23 个", "✓ 示例：cURL, JS, Python", "✅ API 参考文档就绪！"] } },
        benefits: {
        ...
        steps: { label: "运作方式", title: "3 步完成。", s1: { title: "安装", desc: "复制 doc-kit。", code: "cp -r doc-kit ~/.gemini/antigravity/skills/" }, s2: { title: "扫描", desc: "选择 'api' 类型。", code: "bash doc-gen.sh" }, s3: { title: "部署", desc: "AI 生成完整 API 参考。", result: "端点、模式、认证、错误 — cURL/JS/Python 示例。" } },
