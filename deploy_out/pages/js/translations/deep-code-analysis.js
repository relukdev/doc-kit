const codeTranslations = {
    ...
    vi: {
        ...
        solution: { label: "Trace Code Thực", title: "Mỗi claim → (file:dòng).<br>Team verify được.", subtitle: "DocKit Master inspect ORM, routes, middleware, schemas — trích dẫn mọi claim.", terminal: { cmd: "bash doc-gen.sh --scope full", output: ["✓ Trace ORM: 31 entities", "✓ Routes: 67 endpoints", "✓ Middleware chain mapped", "✓ DB: 89 foreign keys", "✓ Mỗi claim có (file:dòng)", "✅ Docs xác minh hoàn tất!"] } },
        benefits: {
        ...
        steps: { label: "Cách Hoạt Động", title: "3 bước.", s1: { title: "Cài", desc: "Copy doc-kit.", code: "cp -r doc-kit ~/.gemini/antigravity/skills/" }, s2: { title: "Phân Tích", desc: "Full scope.", code: "bash doc-gen.sh" }, s3: { title: "Verify", desc: "Mỗi claim có citation.", result: "Click → xem code." } },
    ...
    ru: {
        ...
        solution: { label: "Трассировка кода", title: "Каждое утверждение → (файл:строка).", subtitle: "DocKit Master проверяет ORM, маршруты, middleware.", terminal: { cmd: "bash doc-gen.sh --scope full", output: ["✓ ORM: 31 сущность", "✓ Маршруты: 67", "✓ Middleware mapped", "✓ БД: 89 FK", "✓ Цитаты (файл:строка)", "✅ Верифицируемые docs!"] } },
        benefits: {
        ...
        steps: { label: "Как", title: "3 шага.", s1: { title: "Установка", desc: "Скопируйте.", code: "cp -r doc-kit ~/.gemini/antigravity/skills/" }, s2: { title: "Анализ", desc: "Full scope.", code: "bash doc-gen.sh" }, s3: { title: "Проверка", desc: "Каждое утверждение.", result: "Клик → код." } },
    ...
    zh: {
        ...
        solution: { label: "代码级追踪", title: "每个声明 → (文件:行号)。", subtitle: "DocKit Master 检查 ORM、路由、中间件。", terminal: { cmd: "bash doc-gen.sh --scope full", output: ["✓ ORM: 31 实体", "✓ 路由: 67", "✓ 中间件已映射", "✓ 数据库: 89 FK", "✓ 引用 (文件:行号)", "✅ 可验证文档！"] } },
        benefits: {
        ...
        steps: { label: "方式", title: "3 步。", s1: { title: "安装", desc: "复制。", code: "cp -r doc-kit ~/.gemini/antigravity/skills/" }, s2: { title: "分析", desc: "完整范围。", code: "bash doc-gen.sh" }, s3: { title: "验证", desc: "每个声明有引用。", result: "点击 → 代码。" } },
