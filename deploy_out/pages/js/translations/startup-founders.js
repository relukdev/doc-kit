const startupTranslations = {
    en: {
        ...
        steps: { label: "How It Works", title: "3 steps. Done.", s1: { title: "Install", desc: "Clone and copy doc-kit.", code: "cp -r doc-kit ~/.gemini/antigravity/skills/" }, s2: { title: "Generate", desc: "Select 'all' for complete suite.", code: "bash doc-gen.sh" }, s3: { title: "Ship", desc: "Premium docs site, ready for clients.", result: "Architecture + DB + API + SOPs — enterprise-grade output." } },
    ...
    vi: {
        ...
        solution: { label: "10 Phút → Enterprise-Ready", title: "Bộ docs đầy đủ.<br>Professional-grade. Tự động.", subtitle: "DocKit Master tạo architecture, SOPs, API reference, và docs site premium.", terminal: { cmd: "bash doc-gen.sh --type all --format astro", output: ["✓ Architecture: 4 layers, 23 services", "✓ Database: 31 bảng", "✓ SOP guides mọi flow", "✓ API: 67 endpoints", "✓ Astro Starlight site", "✅ Docs enterprise-ready!"] } },
        benefits: {
        ...
        steps: { label: "Cách Hoạt Động", title: "3 bước. Xong.", s1: { title: "Cài Đặt", desc: "Clone và copy doc-kit.", code: "cp -r doc-kit ~/.gemini/antigravity/skills/" }, s2: { title: "Tạo", desc: "Chọn 'all' cho bộ đầy đủ.", code: "bash doc-gen.sh" }, s3: { title: "Ship", desc: "Docs site premium cho client.", result: "Architecture + DB + API + SOPs — enterprise-grade." } },
    ...
    ru: {
        ...
        solution: { label: "10 минут до enterprise", title: "Полный комплект документации.<br>Профессионального уровня.", subtitle: "DocKit Master генерирует архитектуру, SOP, API и премиум-сайт.", terminal: { cmd: "bash doc-gen.sh --type all --format astro", output: ["✓ Архитектура: 4 слоя, 23 сервиса", "✓ БД: 31 таблица", "✓ SOP руководства", "✓ API: 67 эндпоинтов", "✓ Astro Starlight сайт", "✅ Enterprise-документация готова!"] } },
        benefits: {
        ...
        steps: { label: "Как это работает", title: "3 шага.", s1: { title: "Установка", desc: "Скопируйте doc-kit.", code: "cp -r doc-kit ~/.gemini/antigravity/skills/" }, s2: { title: "Генерация", desc: "Выберите 'all'.", code: "bash doc-gen.sh" }, s3: { title: "Деплой", desc: "Премиум-сайт для клиентов.", result: "Архитектура + БД + API + SOP." } },
    ...
    zh: {
        ...
        solution: { label: "10 分钟到企业级", title: "完整文档套件。<br>专业级。自动化。", subtitle: "DocKit Master 生成架构文档、SOP、API 参考和高级文档网站。", terminal: { cmd: "bash doc-gen.sh --type all --format astro", output: ["✓ 架构：4 层，23 个服务", "✓ 数据库：31 张表", "✓ SOP 指南", "✓ API：67 个端点", "✓ Astro Starlight 网站", "✅ 企业级文档完成！"] } },
        benefits: {
        ...
        steps: { label: "运作方式", title: "3 步完成。", s1: { title: "安装", desc: "复制 doc-kit。", code: "cp -r doc-kit ~/.gemini/antigravity/skills/" }, s2: { title: "生成", desc: "选择 'all'。", code: "bash doc-gen.sh" }, s3: { title: "部署", desc: "高级文档网站。", result: "架构 + 数据库 + API + SOP。" } },
