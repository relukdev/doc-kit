...
Copy the premium template from DocKit Master:

```bash
# Copy premium CSS
cp ~/.gemini/antigravity/skills/DocKit Master/templates/docusaurus-premium/src/css/custom.css \
   docusaurus-site/src/css/custom.css

# Copy premium config as base (then customize below)
cp ~/.gemini/antigravity/skills/DocKit Master/templates/docusaurus-premium/docusaurus.config.ts \
