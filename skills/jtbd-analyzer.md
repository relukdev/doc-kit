...
```mermaid
graph TB
    style MJ fill:#2d333b,stroke:#f78166,color:#e6edf3
    style SJ1 fill:#2d333b,stroke:#6d5dfc,color:#e6edf3
    style SJ2 fill:#2d333b,stroke:#6d5dfc,color:#e6edf3
    style MJ1 fill:#2d333b,stroke:#3fb950,color:#e6edf3
    style MJ2 fill:#2d333b,stroke:#3fb950,color:#e6edf3
    style MJ3 fill:#2d333b,stroke:#3fb950,color:#e6edf3
...
```mermaid
graph TB
    style P fill:#161b22,stroke:#f78166,color:#e6edf3
...
- **Mermaid dark-mode colors**: fill `#2d333b`, stroke `#6d5dfc`, text `#e6edf3`
- **Use color coding** in Mermaid: Main (🔴 `#f78166`), Small (🟣 `#6d5dfc`), Micro (🟢 `#3fb950`)
