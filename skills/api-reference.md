...
```markdown
---
title: "[Resource Name] API Reference"
description: "[Resource] API reference: endpoints, parameters, examples in cURL/Python/JS. Includes auth and error codes."
keywords: ["API", "[resource]", "REST"]
robots: "index, follow"
sidebar:
  order: [number]
---
...
description: "Complete API reference with authentication, endpoints, error codes, and rate limits"
